...
export const calculateEstimate = (rooms: Room[], pricing: Pricing, drywallCompoundNum: number = 0) => {
  let subtotal = 0;
  ...
  const totalDrywallCost = drywallCompoundNum * pricing.drywallCompoundCost * pricing.PROFIT_MARKUP;
