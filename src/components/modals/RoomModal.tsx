      ...
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full transform transition-all duration-300 scale-100 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input type="number" min="0" step="0.1" id="length" name="length" value={formData.length} onChange={handleChange} className={`block w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${fieldErrors.length ? 'border-red-500' : ''}`} />
          ...
          <div>
            ...
            <input type="number" min="0" step="0.1" id="width" name="width" value={formData.width} onChange={handleChange} className={`block w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${fieldErrors.width ? 'border-red-500' : ''}`} />
          ...
          <div>
            ...
            <input type="number" min="0" step="0.1" id="height" name="height" value={formData.height} onChange={handleChange} className={`block w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${fieldErrors.height ? 'border-red-500' : ''}`} />
